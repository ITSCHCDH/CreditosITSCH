...
<div class="marco">
	<p class="parrafo">Por medio del presente le envío un cordial saludo, y aprovecho la oportunidad para hacer de su conocimiento que de acuerdo a lo establecido en el lineamiento para la acreditación de actividades complementarias para el plan de estudios {{ strtoupper($data['plan_de_estudios']) }}, el(a) alumno(a) <strong>{{ $data['alumno']->nombre }}</strong> con el número de control <strong>{{ $data['alumno']->no_control }}</strong> de la carrera {{ strtoupper($data['alumno']->carrera) }} ha <strong style="text-decoration: underline;">concluido satisfactoriamente</strong> con las actividades necesarias para liberar los créditos complementarios. Dichas actividades se resumen a continuación: </p>
	...
	<p class="parrafo" style="margin-bottom: 15px; margin-top: 15px;">Sin más por el momento, me despido de usted y quedo a sus órdenes para cualquier aclaración.</p>
	<div>
