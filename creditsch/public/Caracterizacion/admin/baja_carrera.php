				...
				{ 					
					...
					{	
						jError('Registro Eliminado','Mensaje');
			 			//window.location.href="delete_carrera.php?no_ficha="+$fic; Descomentar para redireccionar y eliminar registro. y subir al servidor el documento php.
					}	
				}
				);							
			}
							...
							$array=mysqli_num_rows($resultado);														
							 if (!empty($array)){
								...
								<fieldset><legend><stroke><b>FICHA ".$ficha."</legend>
									<form name='Bio".$ficha."' method='POST' action=''>
										...
										<table align='right'>
											<tr>
												<td> <br>
													...
													<input value='ELIMINAR' name='Eliminar' id='Eliminar' class='elim' onClick='return preguntar($ficha);' size='6'>
												</td>
											</tr>
										</table>
									</form>
										...
										<table align='right'>
											<tr>
												<td> <br>
													...
													<input value='ELIMINAR' class='elim' name='Eliminar' id='Eliminar' onClick='return preguntar($ficha);' size='6'>
												</td>
											</tr>
										</table>
									</form>
				    	...
				    	<div class='contenedor-3'>";
							...
							$array=mysqli_num_rows($resultado);														
							 if (!empty($array)){
								...
								echo "
								<fieldset><legend><stroke><b>FICHA ".$ficha."</legend>
									<form name='Ind".$ficha."' method='POST' action=''>
										<table width='670' border='0'>
											<tr>
												<td align='center' width='135'><bb>".$nombre."<br> ".$apaterno."<br>".$amaterno."
			        	...
			        	<div class='contenedor-4'>";
							...
							$array=mysqli_num_rows($resultado);														
							 if (!empty($array)){
								...
								echo "
								<fieldset><legend><stroke><b>FICHA ".$ficha."</legend>
									<form name='Meca".$ficha."' method='POST' action=''>
										<table width='670' border='0'>
											<tr>
												<td align='center' width='135'><bb>".$nombre."<br> ".$apaterno."<br>".$amaterno."
				    	...
				    	<div class='contenedor-5'>";
							...
							$array=mysqli_num_rows($resultado);														
							 if (!empty($array)){
								...
								echo "
								<fieldset><legend><stroke><b>FICHA ".$ficha."</legend>
									<form name='Nano".$ficha."' method='POST' action=''>
										<table width='670' border='0'>
											<tr>
												<td align='center' width='135'><bb>".$nombre."<br> ".$apaterno."<br>".$amaterno."
				    	...
				    	<div class='contenedor-6'>";
							...
							$array=mysqli_num_rows($resultado);														
							 if (!empty($array)){
								...
								echo "
								<fieldset><legend><stroke><b>FICHA ".$ficha."</legend>
									<form name='Sist".$ficha."' method='POST' action=''>
										<table width='670' border='0'>
											<tr>
												<td align='center' width='135'><bb>".$nombre."<br> ".$apaterno."<br>".$amaterno."
				    	...
				    	<div class='contenedor-7'>";
							...
							$array=mysqli_num_rows($resultado);														
							 if (!empty($array)){
								...
								echo "
								<fieldset><legend><stroke><b>FICHA ".$ficha."</legend>
									<form name='Tics".$ficha."' method='POST' action=''>
										<table width='670' border='0'>
											<tr>
												<td align='center' width='135'><bb>".$nombre."<br> ".$apaterno."<br>".$amaterno."
