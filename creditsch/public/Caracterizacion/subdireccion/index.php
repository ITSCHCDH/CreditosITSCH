					...
					<div class="sbi_panel" data-bg="../pic/1.jpg">
						...
						<div class="sbi_content">
							<ul>
								...
								<li><a href="consulta_grupal.php">Consulta Grupal</a></li>
								<li><a href="consulta_carrera.php">Consulta por Carrera</a></li>
								<li><a href="asignar_calif.php">Asignar Calif. Examen Adm</a></li>
								<li><a href="asignar_grupo.php">Asignar Grupo</a></li>
							</ul>
						</div>
					</div>
