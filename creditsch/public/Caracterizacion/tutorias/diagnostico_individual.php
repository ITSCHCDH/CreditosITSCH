<html> 
    ...
    <body>
		...
		<div class='topbar'>
			<a><span><i>Inicio / Diagnóstico / Individual</i></span></a>
			<span class='right_ab'>
					<a href='asentar_carrera.php'><strong> Regresar</strong></a>
				</span>
		</div>
	...
	<?PHP
		...
		$query = "SELECT * from alumnos_ficha_medica WHERE no_ficha='$no_ficha'";
		$resultado = $mysqli->query($query);
		$rows = mysqli_fetch_array($resultado);

		$conf_familia=($rows['fm_conf_fam']);
		$cf_madre=substr($conf_familia, -3,1);
		$cf_padre=substr($conf_familia, -2,1);
		$cf_hermanos=substr($conf_familia, -1);

		$conf_familia_otros=($rows['fm_con_fam_otros']);
		$relacion_familiar=($rows['fm_relac_fam']);
		...
		echo "<div class='container'>
			<section class='tabs'>
			    ...
			    <div class='contenedor'>
			    	<form name='diagnostico' method='POST' action='diagnosticar.php'>
			        	<div class='contenedor-1'>
			        		<fieldset><legend><stroke>PERSONALES</stroke></legend>
								<table width='675' border='0'>
									...
									<tr>
										<td><input type='text' name='no_ficha' id='no_ficha' max='5' size='10' align='right' disabled value='$ficha'></td>
							...
							<fieldset><legend><stroke>OTROS</stroke></legend>
								...
								<table>
									<tr>
										<td width='350'><ba>¿Has estado becado?</td>
										<td><ba>¿Cuál?</td>
									</tr>
									<tr>
										<td>";
							...
							<fieldset><legend><stroke>TRABAJO</stroke></legend>
								<table width='675'>
									...
									<tr>
										...
										echo "<td><input type='text' title='Ejemplo: 8:00am a 3:00pm' name='horario' id='horario' size='15' maxlength='15' disabled value='$horario'></td></td>
									</tr>
								</table>
								<table width='675'>
									<tr>								
							...
							<fieldset><legend><stroke>SEMÁFOROS</stroke></legend>
								<table width='675' border='0'>
									...
									<tr>
										<td>";
											if ($tutorias==0){
												echo "<select name='tutorias' id='tutorias' required >
													<option></option>
												...
												echo "<select name='tutorias' id='tutorias' >
													<option value='1'>BIEN</option>
													<option value='2'>LEVE</option>
													<option value='3'>MODERADO</option>
													<option value='4'>GRAVE</option>
						...
						<fieldset><legend><stroke>GENERAL</stroke></legend>
							<table width='675' border='0'>
								...
								<tr>
									<td>
										<input type='text' name='fecha_ficha' id='fecha_ficha' size='15' disabled>
									</td>
									<td>";
									if ($foraneo==1){
						...
						<fieldset>
							...
							<table width='675'>
								...
								<tr>
									...
									<td><select name='diagnostico_probpsico' id='diagnostico_probpsico' required>";
											if ($ps_diagnostico=='Bien'){
												echo "
											...
											elseif($ps_diagnostico=='Moderado')
											{
												echo"
												<option value='Moderado'>MODERADO</option>
												<option value='Bien'>BIEN</option>		
							...
							<table width='675'>
								...
								<tr>
									<td><textarea maxlength='300' rows='3' cols='80' name='machover' id='machover' >$ps_machover</textarea></td>
								</tr>
							</table>
						</fieldset>
						<fieldset>
						...
						<fieldset>
							...
							<table width='675'>
								<tr>
                     				<td><ba>¿Quienes conforman tu familia?</td>
                  				</tr>
                  			</table>
							<table width='675'>
                  				<tr>";
	                  				if ($cf_madre==1){ 
	                     				echo "<td width='150'><input name='chkFM' type='checkbox' id='chkFM' disabled checked>";
	                     			}
	                     			else{
	                     				echo "<td width='150'><input name='chkFM' type='checkbox' id='chkFM' disabled>";
	                     			}
	                        		echo "<pp>Mamá</td>";
	                        		if ($cf_padre==1){
	                     				echo "<td width='150'><input name='chkFP' type='checkbox' id='chkFP' disabled checked>";
	                     			}
	                     			else{
	                     				echo "<td width='150'><input name='chkFP' type='checkbox' id='chkFP' disabled>";
	                     			}
	                        			echo"<pp>Papá</td>";
	                        		if ($cf_hermanos==1){
	                     				echo "<td><input name='chkFH' type='checkbox' id='chkFH' disabled checked>";
	                        		}
	                        		else{
	                        			echo "<td><input name='chkFH' type='checkbox' id='chkFH' disabled>";
	                        		}
	                        		echo "<pp>Hermanos</td>
                        		</tr>
                        	</table>
                        	<table width='675'>
                        		<tr>
                     				<td>
                        				<input name='txfamOtros' type='text' id='txfamOtros' size='40'  value='$conf_familia_otros' disabled/></td>
                  				</tr>
                  			</table>
                  			<table width='675'>
                  				<tr>
                     				<td width='450'><ba>¿Como es tu relación familiar?</td>
									<td><ba>Diagnóstico:</td>
								</tr>
               				</table>
               				<table width='675'>
                  				<tr>";
                  					if($relacion_familiar=='B'){
                     				echo "
                     					<td width='150'><input type='radio' name='radRF' id='radio9' disabled checked/>
                        					<pp>Buena</pp></td>
                     					<td width='150'><input type='radio' name='radRF' id='radio10' disabled />
                        					<pp>Regular</pp></td>
                     					<td width='145'><input type='radio' name='radRF' id='radio11' disabled />
                        					<pp>Mala</pp></td>
                        				<td>
										<select name='probfam' id='probfam' required>";
											if($pf_res=='No'){
												echo"
                        			...
                        			else if($relacion_familiar=='R'){
                        				echo "
                     					<td width='150'><input type='radio' name='radRF' id='radio9' disabled />
                        					<pp>Buena</pp></td>
                     					<td width='150'><input type='radio' name='radRF' id='radio10' disabled checked/>
                        					<pp>Regular</pp></td>
                     					<td width='145'><input type='radio' name='radRF' id='radio11' disabled />
                        					<pp>Mala</pp></td>
                        				<td>
                        				...
                        				echo "
                     					...
                     					<td width='150'><input type='radio' name='radRF' id='radio10' disabled />
                        					<pp>Regular</pp></td>
                     					<td width='145'><input type='radio' name='radRF' id='radio11' disabled checked/>
                        					<pp>Mala</pp></td>
                        				<td>
										<select name='probfam' id='probfam' required>";
											if($pf_res=='No'){
						...
						<br>
							<table align='right'>
								<tr><input type='text' name='fic' id='fic' value='$ficha' hidden>
									<td><input type='submit' value='Diagnosticar' name='guardar' id='guardar'></td>
								</tr>
							</table>
					</div>"; 
		        		estudio_se($no_ficha);
