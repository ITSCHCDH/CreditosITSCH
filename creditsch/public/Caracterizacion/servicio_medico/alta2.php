<html> 
    ...
    if (isset($no_ficha)){
		...
		$link = sqlsrv_connect($server_mssql, array("Database"=>$bd_mssql, "UID"=>$user_mssql, "PWD"=>$pwd_mssql));
			...
			<fieldset> 
				<form name='regitrar_aspirante' method='POST' action='' autocomplete='off'>
		    		<table width='675' align='center'>						
						...
						<tr>
							<td><input type='number' name='peso' id='peso' min='40' max='140' step='0.1'><pp>Kgs</pp></td>
