...
<body>
	<?php
	session_start();
	require_once '../conex_mysql.php';
	$con=new mysqli($hostname,$username,$password,$database);
	if($con->connect_error){
		die("Fallo la conexion a MySQL ");
	}
	
	$alumnos=$_SESSION["contAlumnos"];
	//echo "El numero de registros es :".$alumnos[0];
	...
	//	echo "Alumno Ficha = ".$alumnos[$x].", Calificacion = ".$datos[$x]."<br>";
		...
		$query = "UPDATE alumnos_caracterizacion SET doc_curso_regul_res=$datos[$x] WHERE se_no_ficha='$alumnos[$x]'";
