...
<html lang="es">
	...
	<br>
		<div class="topbar">
			<a><span>Docente - Nanotecnología</span></a>
			<span class="right_ab">
		...
		<br>
				<div id="sbi_container" class="sbi_container">
					<div class="sbi_panel" data-bg="../../pic/1.jpg">
						...
						<div class="sbi_content">
							<ul>
								<li><a href="algebra.php">Reg. Calif. Ciencias Básicas</a></li>
								<li><a href="regularizacion.php">Reg. Calif. de Perfil</a></li>
								<li><a href="consulta.php">Consultar Calificaciones</a></li>
							</ul>
						</div>
					</div>
			...
			<div class="topbar">
				...
				<span class='right_ab'>
					<a href='../'><strong> Regresar</strong></a>
				</span>
			</div>
		</div>
