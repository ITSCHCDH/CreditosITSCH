    ...
    <body>
		...
		<section class='tabs'>
			<div class='contenedor-1' align='justify'>
				<form name="form1" method="post" action="tvocacional3.php" onsubmit="return validarForm(this,nom,numero);">
			    <?php
					session_start();
					...
					//Almacenar estos datos en cookies
					//Generar la nueva consulta y mostrar la tabla
    				$c="select * from orientacion_vocacional where num_pregunta>=21  and num_pregunta<=40 ORDER BY num_pregunta asc";	
