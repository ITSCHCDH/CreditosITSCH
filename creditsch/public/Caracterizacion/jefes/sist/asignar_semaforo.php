<html> 
    ...
    <body>
		...
		<br>
			<div class='topbar'>
				<a><span>Jefe de Carrera - Sistemas</span></a>
				<span class='right_ab'>
	...
	<?PHP
		...
		echo "<div class='container'>
			<section class='tabs'>
		        ...
		        <label for='tab-1' class='tab-label-1'><stroke-2>SIST</label>
							...
							$array=mysqli_num_rows($resultado);														
							 if (!empty($array)){
								...
								<fieldset><legend><stroke><b>FICHA ".$ficha."</legend>
									<form name='Sist".$ficha."' method='POST' action='asignar_individual.php'>
