<html> 
    ...
    <body>
		...
		<br>
			<div class='topbar'>
				<a><span>Jefe de Carrera - Mecatrónica</span></a>
				<span class='right_ab'>
		...
		<div class='topbar'>
			<a><span><i>Inicio / Asignar Semáforo </i></span></a>
	...
	<?PHP
		...
		echo "<div class='container'>
			<section class='tabs'>
		        ...
		        <label for='tab-1' class='tab-label-1'><stroke-2>MECA</label>
							...
							$array=mysqli_num_rows($resultado);														
							 if (!empty($array)){
								...
								<fieldset><legend><stroke><b>FICHA ".$ficha."</legend>
									<form name='Meca".$ficha."' method='POST' action='asignar_individual.php'>
										<table width='670' border='0'>
											<tr>
												...
												<td align='center'><bb>Trabaja<br>";
													if ($trabaja==0){
														echo "<img src='../../images/semaforos/blue.png' alt='Trabaja' height='65' width='65'>";	
													}
													else if ($trabaja==1){
											...
											<tr>
												...
												if ($tutorias==0){
													...
													echo "<img src='../../images/semaforos/naranja.png' alt='Tutorías' height='65' width='65'>";
												}
												else {
												...
												<td align='center'><bb>C. Básicas<br>";
													if ($cb==0){
													echo "<img src='../../images/semaforos/blue.png' alt='C.Basicas' height='65' width='65'>";
												}
												else if ($cb==1){
													echo "<img src='../../images/semaforos/green.png' alt='C.Basicas' height='65' width='65'>";
												}
												else if ($cb==2){
													echo "<img src='../../images/semaforos/yellow.png' alt='C.Basicas' height='65' width='65'>";
												}
												else if ($cb==3){
													echo "<img src='../../images/semaforos/naranja.png' alt='C.Basicas' height='65' width='65'>";
												}
												else {
													echo "<img src='../../images/semaforos/red.png' alt='C.Basicas' height='65' width='65'>";
												}
												echo "
												</td>
												<td align='center'><bb>J. de Carrera<br>";
												if ($jc==0){
													echo "<img src='../../images/semaforos/blue.png' alt='J.Carrera' height='65' width='65'>";
												}
												else if ($jc==1){
													echo "<img src='../../images/semaforos/green.png' alt='J.Carrera' height='65' width='65'>";
												}
												else if ($jc==2){
													echo "<img src='../../images/semaforos/yellow.png' alt='J.Carrera' height='65' width='65'>";
												}
												else if ($jc==3){
													echo "<img src='../../images/semaforos/naranja.png' alt='J.Carrera' height='65' width='65'>";
												}
												else {
													echo "<img src='../../images/semaforos/red.png' alt='J.Carrera' height='65' width='65'>";
												}
												echo "
												</td>
											</tr>
										...
										<table align='right'>
											<tr>
												<td> <br>
													...
													<input type='submit' value='Asignar' name='guardar' id='guardar'>
												</td>
											</tr>
										</table>
									</form>
