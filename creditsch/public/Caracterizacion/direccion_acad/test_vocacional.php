...
<html lang="es">
	...
	<br>
		<div class="topbar">
			<a><span>Dirección Académica</span></a>
			<span class='right_ab'>
	...
	<div class="topbar">
		<a><span><i>Inicio / Resultado Test Vocacional</i></span></a>
		<span class='right_ab'>
			<?PHP echo ("<a href='javascript:history.back(1)'><strong>Regresar</strong></a>")  ?>
		</span>
	</div>
	<?PHP require_once '../funciones/funciones.php';
		if(isset($_POST['test'])){
			$ficha=$_POST['ficha'];
			test_vocacional($ficha);	
		}
		else{
